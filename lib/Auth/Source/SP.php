...
class SP extends Source
{
    ...
    private function startDisco(array $state)
    {
        ...
        $returnTo = \SimpleSAML\Module::getModuleURL('sildisco/sp/discoresp.php', ['AuthID' => $id]);
    ...
    public static function reauthLogout(array $state)
    {
        ...
        $state['Responder'] = ['\SimpleSAML\Module\sildisco\Auth\Source\SP', 'reauthPostLogout'];
    ...
    public function handleResponse(array $state, $idp, array $attributes)
    {
        ...
        $authProcState = [
            'saml:sp:IdP' => $idp,
            'saml:sp:State' => $state,
			'ReturnCall' => ['\SimpleSAML\Module\sildisco\Auth\Source\SP', 'onProcessingCompleted'],
