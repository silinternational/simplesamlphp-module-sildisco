...
class sspmod_sildisco_Auth_Source_SP extends SimpleSAML_Auth_Source {
    ...
    public static function reauthLogout(array $state)
    {
        ...
        $state['Responder'] = array('sspmod_sildisco_Auth_Source_SP', 'reauthPostLogout');
    ...
    public static function reauthPostLogout(SimpleSAML_IdP $idp, array $state) {
        ...
        $sp = SimpleSAML_Auth_Source::getById($state['saml:sp:AuthId'], 'sspmod_sildisco_Auth_Source_SP');
